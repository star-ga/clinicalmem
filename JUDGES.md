...
2. **Recall gate (PCCP):** **100% recall** on every severity class
   ...
   contraindicated (22/22), major (4/4), serious (69/69), moderate
...
Optional: full pytest suite — `python3 -m pytest tests/test_engine/ tests/test_scripts/ -q`. Should report **1042+ passed**.
...
|---|---|
| `100% recall · contraindicated · 22/22` | `docs/openevidence_cache.json` (118 entries) → `docs/pccp_eval_latest.json` (per-pair verdicts) |
