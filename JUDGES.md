...
2. **Recall gate (PCCP):** **100% recall** on every severity class
   represented in the 132-pair OpenEvidence-cited cohort —
...
#    major / serious / moderate against the 132-pair OpenEvidence-cited
#    cohort.
...
|---|---|
| `100% recall · contraindicated · 37/37` | `docs/openevidence_cache.json` (132 entries) → `docs/pccp_eval_latest.json` (per-pair verdicts) |
