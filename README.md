...
<p align="center">
  <a href="#tests"><img src="https://img.shields.io/badge/tests-1373%20passed-brightgreen?style=flat-square" alt="Tests"></a>
...
| **Test coverage** | 1373+ tests across engine + scripts; line coverage measured per-suite via `pytest --cov` (not enforced as headline) | Untested |
...
├── .github/workflows/
│   ├── test.yaml               # CI: Run tests on push (1373+ tests across engine + scripts)
...
**1373 tests** across `tests/test_engine/`, `tests/test_scripts/`,
...
tests/test_engine/         — 600+ tests covering the safety pipeline:
   ...
   federation transport bridge (mind-mem v3.10.1 MemoryMesh +
