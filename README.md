...
<p align="center">
  <a href="#tests"><img src="https://img.shields.io/badge/tests-1370%20passed-brightgreen?style=flat-square" alt="Tests"></a>
...
**1370 tests** across `tests/test_engine/`, `tests/test_scripts/`,
...
tests/test_engine/         — 600+ tests covering the safety pipeline:
   ...
   federation transport bridge (mind-mem v3.9.1 MemoryMesh +
