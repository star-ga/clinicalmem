...
<p align="center">
  <a href="#tests"><img src="https://img.shields.io/badge/tests-1409%20passed-brightgreen?style=flat-square" alt="Tests"></a>
...
| **Test coverage** | 1409+ tests across engine + scripts; line coverage measured per-suite via `pytest --cov` (not enforced as headline) | Untested |
...
├── .github/workflows/
│   ├── test.yaml               # CI: Run tests on push (1409+ tests across engine + scripts)
...
**1409 tests** across `tests/test_engine/`, `tests/test_scripts/`,
