...
All 17 patients are entirely fictional, computer-generated characters. Their names (e.g., "Raymond Okafor", "Sandra Kowalski", "Adelaide Vasquez", "Walter Hawthorne", "Henrik Magnussen", "Beatriz Pereira", "Aleksandra Volkov"), dates of birth, addresses, and medical histories were constructed solely for demonstration purposes using synthetic identifiers. No real person corresponds to any entry.
