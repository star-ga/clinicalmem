...
| 4. 6-LLM US-based consensus | `engine/consensus_engine.py` | ~1–3 s | Frontier reasoning over novel pairs (GPT-5.5 / Gemini 3.1 Pro / Grok 4.3 / Claude Opus 4.7 / Perplexity Sonar Pro / NVIDIA Nemotron Ultra 253B) |
