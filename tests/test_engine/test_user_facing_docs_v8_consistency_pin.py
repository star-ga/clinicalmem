...
Files NOT scanned (intentionally excluded):
  - AGENTS.md                    — auto-regenerated by claude-mem;
                                    untracked from public repo at
                                    iter-2026-05-11 cleanup.
  - demo-script-v*.md            — local production blueprints for
                                    the YouTube video; untracked at
                                    iter-2026-05-11 cleanup.
  - EVAL_*.json                  — local LLM critique snapshots;
                                    untracked at iter-2026-05-11.
...
_USER_FACING_DOCS = (
    ...
    # demo-script-v2.md untracked from public repo at iter-2026-05-11
    # cleanup (kept local as a production blueprint for the YouTube
    # video; reveals internal multi-LLM-critique authoring process so
    # it stays out of the public tree). Removed from this scope so
    # the pin doesn't FileNotFoundError on a clean clone.
