...
- *"Feasibility"* — live deployment, audit trail, abstention, 235+ tests, Apache-2.0 with patent grant, MCP + A2A both. Every other entry has at least one missing pillar.
